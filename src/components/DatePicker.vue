  ...
  <div class="e-calendar-wrapper">
    <div class="e-calendar">
        ...
        <div class="e-calendar-monthday">
          <transition :name="fadeXType">
            <div :key="showDate.monthStr" class="e-calendar-monthday-wrapper">
              <div class="e-calendar-monthday-row" v-for="row in rows" :key="row">
                <span v-for="day in row" class="e-calendar-monthday-row-day" @click="selectDay(day)" :key="day" :class="{'active': day.selected, 'disabled': day.disabled}">
      ...
      <ul class="e-calendar-year" v-show="showYear" ref="yearList">
        <li v-for="item in yearList" v-text="item" :key="item" :class="{'active': item === selectDate.year}" @click="selectYear(item)"></li>
      </ul>
